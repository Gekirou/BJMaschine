...
//	        
	 	...
	 	public void calculateAndShowUsr1XP(long id, boolean winner){
	 		...
	 		double[] usr1pts = 	XPCalculator.calcXP(this, DataHolder.usr1ID, id, DataHolder.volume_value, DataHolder.anzahl_value, dauerms1, winner);
 			...
 			if(usr1pts[0]!=0){
 				...
 				rankBTV.setVisibility(View.GONE);
 			}
	 	...
	 	public void calculateAndShowUsr2XP(long id, boolean winner){
	 		...
	 		double[] usr1pts = XPCalculator.calcXP(this, DataHolder.usr2ID, id, DataHolder.volume_value, DataHolder.anzahl_value, dauerms2, winner);
